...
attribute-surface snapshot to ``engrish/tests/baselines/wikidict_attrs_upstream.json``.

Usage::

    ./venv/bin/python engrish/tests/baselines/generate_wikidict_baseline.py
...
# Kept in sync with engrish/tests/harness/parity.py::AUDITED_MODULES.
AUDITED_MODULES = (
    "wikidict",
    "wikidict.constants",
    "wikidict.convert",
