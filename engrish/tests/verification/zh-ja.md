...
| §5 .df & synonym count | - | 232 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=214,156 | .df @ count=214,156 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=232 | .df & count=232 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 232 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 214,156 entries | 14,630 have ≥ 2 <h3> | ✓ | OK |  |
