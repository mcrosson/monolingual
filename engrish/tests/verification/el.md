...
| §5 .df & synonym count | - | 51,182 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=30,605 | .df @ count=30,605 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=51,182 | .df & count=51,182 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 51,182 & lines | 0 broken | ✓ | OK |  |
