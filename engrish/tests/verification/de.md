...
| §5 .df & synonym count | - | 142,339 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=195,909 | .df @ count=195,909 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=142,339 | .df & count=142,339 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 142,339 & lines | 0 broken | ✓ | OK |  |
