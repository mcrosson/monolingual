...
| §5 .df & synonym count | - | 2,508 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=18,550 | .df @ count=18,550 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=2,508 | .df & count=2,508 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 2,508 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 18,550 entries | 1,014 have ≥ 2 <h3> | ✓ | OK |  |
