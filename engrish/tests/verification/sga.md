...
| §5 .df & synonym count | - | 1,110 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=3,944 | .df @ count=3,944 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=1,110 | .df & count=1,110 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 1,110 & lines | 0 broken | ✓ | OK |  |
