...
| §5 .df & synonym count | - | 19,839 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=20,836 | .df @ count=20,836 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=19,839 | .df & count=19,839 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 19,839 & lines | 0 broken | ✓ | OK |  |
