...
| §5 .df & synonym count | - | 2,485 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=15,241 | .df @ count=15,241 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=2,485 | .df & count=2,485 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 2,485 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 15,241 entries | 999 have ≥ 2 <h3> | ✓ | OK |  |
