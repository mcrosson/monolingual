...
| §5 .df & synonym count | - | 196 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=38,118 | .df @ count=38,118 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=196 | .df & count=196 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 196 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 38,118 entries | 567 have ≥ 2 <h3> | ✓ | OK |  |
