...
| §5 .df & synonym count | - | 408,017 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=158,486 | .df @ count=158,486 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=408,017 | .df & count=408,017 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 408,017 & lines | 0 broken | ✓ | OK |  |
