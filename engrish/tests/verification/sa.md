...
| §5 .df & synonym count | - | 1,118 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=8,794 | .df @ count=8,794 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=1,118 | .df & count=1,118 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 1,118 & lines | 0 broken | ✓ | OK |  |
