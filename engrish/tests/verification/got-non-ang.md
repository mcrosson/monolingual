...
| §5 .df & synonym count | - | 26,094 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=29,016 | .df @ count=29,016 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=26,094 | .df & count=26,094 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 26,094 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 29,016 entries | 278 have ≥ 2 <h3> | ✓ | OK |  |
