...
| §5 .df & synonym count | - | 517,842 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=875,817 | .df @ count=875,817 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=517,842 | .df & count=517,842 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 517,842 & lines | 0 broken | ✓ | OK |  |
