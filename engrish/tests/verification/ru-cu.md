...
| §5 .df & synonym count | - | 21,071 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=61,274 | .df @ count=61,274 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=21,071 | .df & count=21,071 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 21,071 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 61,274 entries | 697 have ≥ 2 <h3> | ✓ | OK |  |
