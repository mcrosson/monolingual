...
| §5 .df & synonym count | - | 839,625 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=916,230 | .df @ count=916,230 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=839,625 | .df & count=839,625 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 839,625 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 916,230 entries | 24,199 have ≥ 2 <h3> | ✓ | OK |  |
