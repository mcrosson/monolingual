...
| §5 .df & synonym count | - | 20,787 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=57,674 | .df @ count=57,674 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=20,787 | .df & count=20,787 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 20,787 & lines | 0 broken | ✓ | OK |  |
