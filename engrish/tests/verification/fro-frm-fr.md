...
| §5 .df & synonym count | - | 272,076 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=100,682 | .df @ count=100,682 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=272,076 | .df & count=272,076 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 272,076 & lines | 0 broken | ✓ | OK |  |
| §7 multi-locale entries carry ≥ 2 <h3> sections | 100,682 entries | 4,777 have ≥ 2 <h3> | ✓ | OK |  |
