...
| §5 .df & synonym count | - | 1,698 | ✓ | OK |  |
| §6 .ifo wordcount == .df @ count | .ifo wordcount=7,076 | .df @ count=7,076 | ✓ | OK |  |
| §6 .ifo synwordcount == .df & count | .ifo synwordcount=1,698 | .df & count=1,698 | ✓ | OK |  |
| §5 every & synonym points at a real @ | 1,698 & lines | 0 broken | ✓ | OK |  |
