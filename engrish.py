...
# ---------------------------------------------------------------------------
# language-stats subcommand
# ---------------------------------------------------------------------------

def _load_language_codes(db_path: Path) -> dict[str, str]:
...
def _scan_language_stats(db_path: Path) -> dict[str, dict[str, int]]:
...
def _cmd_language_stats() -> int:
    ...
    name_to_code = _load_language_codes(db_path)
    log.info("Loaded %d language code mappings", len(name_to_code))

    stats = _scan_language_stats(db_path)
